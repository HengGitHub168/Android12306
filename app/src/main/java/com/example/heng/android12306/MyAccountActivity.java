...
public class MyAccountActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, mData, R.layout.my_account_item, new String[]{"a1", "a2"}, new int[]{R.id.textNew1, R.id.textNew2});
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        ...
                        final EditText et_userName = new EditText(MyAccountActivity.this);//定义一个文本输入框
        ...
        * */
                    ...
                    case 2:
                        ...
                        final EditText et_userName2 = new EditText(MyAccountActivity.this);//定义一个文本输入框
                    ...
                    case 3:
                        //创建一个Builder对象
                        AlertDialog.Builder builder3 = new AlertDialog.Builder(MyAccountActivity.this);
        ...
        * */
                    ...
                    case 4:
                        //创建一个Builder对象
                        AlertDialog.Builder builder4 = new AlertDialog.Builder(MyAccountActivity.this);
                        ...
                        final EditText et_userName4 = new EditText(MyAccountActivity.this);//定义一个文本输入框
        ...
        bntMyContactSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String idCard=et_userName2.getText().toString();
                String phone=et_userName4.getText().toString();
               // SQLiteDatabase db=dbHelper.getWritableDatabase();
                ContentValues values=new ContentValues();
                values.put("email",name);
                values.put("password","heng");
                values.put("userName",name);
                values.put("gender","男");
                values.put("idCard",idCard);
                values.put("phone",phone);
                values.put("lastTime","1234");
                values.put("userSate","2");
              //  db.update("person",values,null,null);
                db.update("person",values,"lastTime=?",new String[]{"1234"});

                Toast.makeText(MyAccountActivity.this, "修改成功" , Toast.LENGTH_LONG).show();
            }
        });
    }
